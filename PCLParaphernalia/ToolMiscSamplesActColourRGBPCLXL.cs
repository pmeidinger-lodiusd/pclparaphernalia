...
namespace PCLParaphernalia
{
    ...
    ///
    /// </summary>
    internal static class ToolMiscSamplesActColourRGBPCLXL
    {
        //--------------------------------------------------------------------//
        //                                                        F i e l d s //
        ...
        private const short _patternId_1 = 601;
        ...
        private static void GenerateOverlay(BinaryWriter prnWriter, bool formAsMacro, int indxPaperSize, int indxOrientation)
        {
            ...
            boxX2 = (ushort)(PCLPaperSizes.GetPaperWidth(
                                    ...
                                    PCLOrientations.Aspect.Portrait) - boxX1);

            boxY2 = (ushort)(PCLPaperSizes.GetPaperLength(
                                    indxPaperSize, _unitsPerInch,
                                    PCLOrientations.Aspect.Portrait) - boxY1);
                                         ...
                                         bool formAsMacro)
        {
            ...
            PCLXLWriter.Font(prnWriter, false, ptSize, _symSet_19U, _fontNameCourier);
        ...
        private static void PatternDefineDpi600(BinaryWriter prnWriter, short patternId, bool embedded)
        {
            const ushort patWidth = 16;
            const ushort patHeight = 16;

            const ushort destWidth = (patWidth * _unitsPerInch) / 600;
            const ushort destHeight = (patHeight * _unitsPerInch) / 600;
