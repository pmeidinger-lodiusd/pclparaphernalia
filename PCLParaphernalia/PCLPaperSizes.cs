...
namespace PCLParaphernalia
{
    /// <summary>
    ///
    /// <para>Class defines a set of PCL Paper Size objects.</para>
    ...
    static class PCLPaperSizes
    {
        ...
        private static int _paperSizeCount;
        ...
        public static ushort GetLogicalOffset(int index, ushort sessionUPI, PCLOrientations.Aspect aspect)
        {
        ...
        public static ushort GetLogPageLength(int index, ushort sessionUPI, PCLOrientations.Aspect aspect)
        {
        ...
        public static ushort GetLogPageWidth(int index, ushort sessionUPI, PCLOrientations.Aspect aspect)
        {
        ...
        public static ushort GetMarginsLogicalLand(int index, ushort sessionUPI)
        {
        ...
        public static ushort GetMarginsLogicalPort(int index, ushort sessionUPI)
        {
        ...
        public static ushort GetMarginsUnprintable(int index, ushort sessionUPI)
        {
        ...
        public static ushort GetPaperLength(int index, ushort sessionUPI, PCLOrientations.Aspect aspect)
        {
        ...
        public static ushort GetPaperWidth(int index, ushort sessionUPI, PCLOrientations.Aspect aspect)
        {
        ...
        public static ushort GetSizeLongEdge(int index, ushort sessionUPI)
        {
        ...
        public static ushort GetSizeShortEdge(int index, ushort sessionUPI)
        {
        ...
        private static void PopulateTable()
        {
            ...
            _paperSizes = new PCLPaperSize[]
            {
                ...
                new PCLPaperSize(Index.Default,
                                 ...
                                 string.Empty,
                                 0xff,
                                 (byte)PCLXLAttrEnums.Val.eDefaultPapersize,
                                 string.Empty,
                                 sizeIsImperial,
                                 sizeIsCommon,
                                 _paperSizeUPI,
                ...
                new PCLPaperSize(Index.ANSI_A_Letter,
                                 ...
                                 "(ANSI A): 8.5\" x 11\"",
                                 2,
                                 (byte)PCLXLAttrEnums.Val.eLetterPaper,
                                 "LETTER",
                                 sizeIsImperial,
                                 sizeIsCommon,
                                 _paperSizeUPI,
                ...
                new PCLPaperSize(Index.ANSI_B_Ledger_Tabloid,
                                 ...
                                 6,
                                 (byte)PCLXLAttrEnums.Val.eLedgerPaper,
                                 "LEDGER",
                                 sizeIsImperial,
                                 sizeIsCommon,
                                 _paperSizeUPI,
                ...
                new PCLPaperSize(Index.Env_Com10,
                                 ...
                                 "4.125\" x 9.5\"",
                                 81,
                                 (byte)PCLXLAttrEnums.Val.eCOM10Envelope,
                                 "COM10",
                                 sizeIsImperial,
                                 sizeIsCommon,
                                 _paperSizeUPI,
                ...
                new PCLPaperSize(Index.Env_Intl_B5,
                                 ...
                                 "176 mm x 250 mm",
                                 100,
                                 (byte)PCLXLAttrEnums.Val.eB5Envelope,
                                 "B5 ENV",
                                 sizeIsMetric,
                                 sizeIsCommon,
                                 _paperSizeUPI,
                ...
                new PCLPaperSize(Index.Env_Intl_C5,
                                 ...
                                 "162 mm x 229 mm",
                                 91,
                                 (byte)PCLXLAttrEnums.Val.eC5Envelope,
                                 "C5",
                                 sizeIsMetric,
                                 sizeIsCommon,
                                 _paperSizeUPI,
                ...
                new PCLPaperSize(Index.Env_Intl_DL,
                                 ...
                                 "110 mm x 220 mm",
                                 90,
                                 (byte)PCLXLAttrEnums.Val.eDLEnvelope,
                                 "DL",
                                 sizeIsMetric,
                                 sizeIsCommon,
                                 _paperSizeUPI,
                ...
                new PCLPaperSize(Index.Env_Monarch,
                                 ...
                                 "3.875\" x 7.5\"",
                                 80,
                                 (byte)PCLXLAttrEnums.Val.eMonarchEnvelope,
                                 "MONARCH",
                                 sizeIsImperial,
                                 sizeIsCommon,
                                 _paperSizeUPI,
                ...
                new PCLPaperSize(Index.Executive,
                                 ...
                                 "7.25\" x 10.5\"",
                                 1,
                                 (byte)PCLXLAttrEnums.Val.eExecPaper,
                                 "EXEC",
                                 sizeIsImperial,
                                 sizeIsCommon,
                                 _paperSizeUPI,
                ...
                new PCLPaperSize(Index.ISO_A3,
                                 ...
                                 "297 mm x 420 mm",
                                 27,
                                 (byte)PCLXLAttrEnums.Val.eA3Paper,
                                 "A3",
                                 sizeIsMetric,
                                 sizeIsCommon,
                                 _paperSizeUPI,
                ...
                new PCLPaperSize(Index.ISO_A4,
                                 ...
                                 "210 mm x 297 mm",
                                 26,
                                 (byte)PCLXLAttrEnums.Val.eA4Paper,
                                 "A4",
                                 sizeIsMetric,
                                 sizeIsCommon,
                                 _paperSizeUPI,
                ...
                new PCLPaperSize(Index.ISO_A5,
                                 ...
                                 "148 mm x 210 mm",
                                 25,
                                 (byte)PCLXLAttrEnums.Val.eA5Paper,
                                 "A5",
                                 sizeIsMetric,
                                 sizeIsCommon,
                                 _paperSizeUPI,
                ...
                new PCLPaperSize(Index.ISO_A6,
                                 ...
                                 "105 mm x 148 mm",
                                 24,
                                 (byte)PCLXLAttrEnums.Val.eA6Paper,
                                 "A6",
                                 sizeIsMetric,
                                 sizeIsCommon,
                                 _paperSizeUPI,
                ...
                new PCLPaperSize(Index.ISO_B5,
                                 ...
                                 "176 mm x 250 mm",
                                 65,
                                 (byte)PCLXLAttrEnums.Val.eB5Paper,
                                 string.Empty,
                                 sizeIsMetric,
                                 sizeIsRare,
                                 _paperSizeUPI,
                ...
                new PCLPaperSize(Index.JIS_B4,
                                 ...
                                 "257 mm x 364 mm",
                                 46,
                                 (byte)PCLXLAttrEnums.Val.eJB4Paper,
                                 "JIS_B4",
                                 sizeIsMetric,
                                 sizeIsCommon,
                                 _paperSizeUPI,
                ...
                new PCLPaperSize(Index.JIS_B5,
                                 ...
                                 "182 mm x 257 mm",
                                 45,
                                (byte)PCLXLAttrEnums.Val.eJB5Paper,
                                 "JIS B5",
                                 sizeIsMetric,
                                 sizeIsCommon,
                                 _paperSizeUPI,
                ...
                new PCLPaperSize(Index.JIS_B6,
                                 ...
                                 "128 mm x 182 mm",
                                 44,
                                 (byte)PCLXLAttrEnums.Val.eJB6Paper,
                                 "JIS B6",
                                 sizeIsMetric,
                                 sizeIsCommon,
                                 _paperSizeUPI,
                ...
                new PCLPaperSize(Index.JIS_Executive,
                                 ...
                                 "216 mm x 330 mm",
                                 18,
                                 (byte)PCLXLAttrEnums.Val.eJISExecPaper,
                                 string.Empty,
                                 sizeIsMetric,
                                 sizeIsRare,
                                 _paperSizeUPI,
                ...
                new PCLPaperSize(Index.JP_Postcard,
                                 ...
                                 71,
                                 (byte)PCLXLAttrEnums.Val.eJPostcard,
                                 "JPOST",
                                 sizeIsMetric,
                                 sizeIsCommon,
                                 _paperSizeUPI,
                ...
                new PCLPaperSize(Index.JP_PostcardDouble,
                                 ...
                                 72,
                                 (byte)PCLXLAttrEnums.Val.eJDoublePostcard,
                                 "JPOSTD",
                                 sizeIsMetric,
                                 sizeIsCommon,
                                 _paperSizeUPI,
                ...
                new PCLPaperSize(Index.Legal,
                                 ...
                                 "8.5\" x 14\"",
                                 3,
                                 (byte)PCLXLAttrEnums.Val.eLegalPaper,
                                 "LEGAL",
                                 sizeIsImperial,
                                 sizeIsCommon,
                                 _paperSizeUPI,
        ...
        public static void SetCustomLongEdge(ushort size, ushort sessionUPI)
        {
            _paperSizes[(int)Index.Custom].CustomLongEdge = (uint)((size * _paperSizeUPI) / sessionUPI);
        }
        ...
        public static void SetCustomShortEdge(ushort size, ushort sessionUPI)
        {
            _paperSizes[(int)Index.Custom].CustomShortEdge = (uint)((size * _paperSizeUPI) / sessionUPI);
        }
    }
}