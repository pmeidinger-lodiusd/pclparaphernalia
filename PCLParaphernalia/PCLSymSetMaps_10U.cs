...
static partial class PCLSymSetMaps
{
    ...
    // ID       10U                                                       //
    // Kind1    341                                                       //
    // Name     PC-8 Code Page 437                                        //
    //                                                                    //
    //--------------------------------------------------------------------//

    private static void UnicodeMap_10U()
    {
        const eSymSetMapId mapId = eSymSetMapId.map_10U;
        ...
        mapDataStd[2][0xa9 - rangeMin] = 0x2310;
        ...
        mapDataStd[2][0xe0 - rangeMin] = 0x03b1;
        mapDataStd[2][0xe1 - rangeMin] = 0x00df;
        mapDataStd[2][0xe2 - rangeMin] = 0x0393;
        mapDataStd[2][0xe3 - rangeMin] = 0x03c0;
        mapDataStd[2][0xe4 - rangeMin] = 0x03a3;
        mapDataStd[2][0xe5 - rangeMin] = 0x03c3;
        mapDataStd[2][0xe6 - rangeMin] = 0x00b5;
        mapDataStd[2][0xe7 - rangeMin] = 0x03c4;
        mapDataStd[2][0xe8 - rangeMin] = 0x03a6;
        mapDataStd[2][0xe9 - rangeMin] = 0x0398;
        mapDataStd[2][0xea - rangeMin] = 0x03a9;
        mapDataStd[2][0xeb - rangeMin] = 0x03b4;
        mapDataStd[2][0xec - rangeMin] = 0x221e;
        mapDataStd[2][0xed - rangeMin] = 0x03c6;
        mapDataStd[2][0xee - rangeMin] = 0x03b5;
        mapDataStd[2][0xef - rangeMin] = 0x2229;

        mapDataStd[2][0xf0 - rangeMin] = 0x2261;
        mapDataStd[2][0xf1 - rangeMin] = 0x00b1;
        mapDataStd[2][0xf2 - rangeMin] = 0x2265;
        mapDataStd[2][0xf3 - rangeMin] = 0x2264;
        mapDataStd[2][0xf4 - rangeMin] = 0x2320;
        mapDataStd[2][0xf5 - rangeMin] = 0x2321;
        mapDataStd[2][0xf6 - rangeMin] = 0x00f7;
        mapDataStd[2][0xf7 - rangeMin] = 0x2248;
        ...
        mapDataStd[2][0xfc - rangeMin] = 0x207f;
