...
namespace PCLParaphernalia
{
    ...
    static partial class PCLSymSetMaps
    {
        ...
        // ID       10G                                                       //
        // Kind1    327                                                       //
        // Name     PC-851 Latin/Greek                                        //
        //                                                                    //
        //--------------------------------------------------------------------//

        private static void unicodeMap_10G()
        {
            const eSymSetMapId mapId = eSymSetMapId.map_10G;
            ...
            mapDataStd[2][0x86 - rangeMin] = 0x0386;
            ...
            mapDataStd[2][0x8d - rangeMin] = 0x0388;
            mapDataStd[2][0x8e - rangeMin] = 0x00c4;
            mapDataStd[2][0x8f - rangeMin] = 0x0389;

            mapDataStd[2][0x90 - rangeMin] = 0x038a;
            mapDataStd[2][0x91 - rangeMin] = 0xffff;    //<not a character> //
            mapDataStd[2][0x92 - rangeMin] = 0x038c;
            mapDataStd[2][0x93 - rangeMin] = 0x00f4;
            mapDataStd[2][0x94 - rangeMin] = 0x00f6;
            mapDataStd[2][0x95 - rangeMin] = 0x038e;
            mapDataStd[2][0x96 - rangeMin] = 0x00fb;
            mapDataStd[2][0x97 - rangeMin] = 0x00f9;
            mapDataStd[2][0x98 - rangeMin] = 0x038f;
            mapDataStd[2][0x99 - rangeMin] = 0x00d6;
            mapDataStd[2][0x9a - rangeMin] = 0x00dc;
            mapDataStd[2][0x9b - rangeMin] = 0x03ac;
            mapDataStd[2][0x9c - rangeMin] = 0x00a3;
            mapDataStd[2][0x9d - rangeMin] = 0x03ad;
            mapDataStd[2][0x9e - rangeMin] = 0x03ae;
            mapDataStd[2][0x9f - rangeMin] = 0x03af;

            mapDataStd[2][0xa0 - rangeMin] = 0x03ca;
            mapDataStd[2][0xa1 - rangeMin] = 0x0390;
            mapDataStd[2][0xa2 - rangeMin] = 0x03cc;
            mapDataStd[2][0xa3 - rangeMin] = 0x03cd;
            mapDataStd[2][0xa4 - rangeMin] = 0x0391;
            mapDataStd[2][0xa5 - rangeMin] = 0x0392;
            mapDataStd[2][0xa6 - rangeMin] = 0x0393;
            mapDataStd[2][0xa7 - rangeMin] = 0x0394;
            mapDataStd[2][0xa8 - rangeMin] = 0x0395;
            mapDataStd[2][0xa9 - rangeMin] = 0x0396;
            mapDataStd[2][0xaa - rangeMin] = 0x0397;
            mapDataStd[2][0xab - rangeMin] = 0x00bd;
            mapDataStd[2][0xac - rangeMin] = 0x0398;
            mapDataStd[2][0xad - rangeMin] = 0x0399;
            ...
            mapDataStd[2][0xb5 - rangeMin] = 0x039a;
            mapDataStd[2][0xb6 - rangeMin] = 0x039b;
            mapDataStd[2][0xb7 - rangeMin] = 0x039c;
            mapDataStd[2][0xb8 - rangeMin] = 0x039d;
            ...
            mapDataStd[2][0xbd - rangeMin] = 0x039e;
            mapDataStd[2][0xbe - rangeMin] = 0x039f;
            ...
            mapDataStd[2][0xc6 - rangeMin] = 0x03a0;
            mapDataStd[2][0xc7 - rangeMin] = 0x03a1;
            ...
            mapDataStd[2][0xcf - rangeMin] = 0x03a3;

            mapDataStd[2][0xd0 - rangeMin] = 0x03a4;
            mapDataStd[2][0xd1 - rangeMin] = 0x03a5;
            mapDataStd[2][0xd2 - rangeMin] = 0x03a6;
            mapDataStd[2][0xd3 - rangeMin] = 0x03a7;
            mapDataStd[2][0xd4 - rangeMin] = 0x03a8;
            mapDataStd[2][0xd5 - rangeMin] = 0x03a9;
            mapDataStd[2][0xd6 - rangeMin] = 0x03b1;
            mapDataStd[2][0xd7 - rangeMin] = 0x03b2;
            mapDataStd[2][0xd8 - rangeMin] = 0x03b3;
            ...
            mapDataStd[2][0xdd - rangeMin] = 0x03b4;
            mapDataStd[2][0xde - rangeMin] = 0x03b5;
            mapDataStd[2][0xdf - rangeMin] = 0x2580;

            mapDataStd[2][0xe0 - rangeMin] = 0x03b6;
            mapDataStd[2][0xe1 - rangeMin] = 0x03b7;
            mapDataStd[2][0xe2 - rangeMin] = 0x03b8;
            mapDataStd[2][0xe3 - rangeMin] = 0x03b9;
            mapDataStd[2][0xe4 - rangeMin] = 0x03ba;
            mapDataStd[2][0xe5 - rangeMin] = 0x03bb;
            mapDataStd[2][0xe6 - rangeMin] = 0x03bc;
            mapDataStd[2][0xe7 - rangeMin] = 0x03bd;
            mapDataStd[2][0xe8 - rangeMin] = 0x03be;
            mapDataStd[2][0xe9 - rangeMin] = 0x03bf;
            mapDataStd[2][0xea - rangeMin] = 0x03c0;
            mapDataStd[2][0xeb - rangeMin] = 0x03c1;
            mapDataStd[2][0xec - rangeMin] = 0x03c3;
            mapDataStd[2][0xed - rangeMin] = 0x03c2;
            mapDataStd[2][0xee - rangeMin] = 0x03c4;
            mapDataStd[2][0xef - rangeMin] = 0x0384;

            mapDataStd[2][0xf0 - rangeMin] = 0x00ad;
            mapDataStd[2][0xf1 - rangeMin] = 0x00b1;
            mapDataStd[2][0xf2 - rangeMin] = 0x03c5;
            mapDataStd[2][0xf3 - rangeMin] = 0x03c6;
            mapDataStd[2][0xf4 - rangeMin] = 0x03c7;
            mapDataStd[2][0xf5 - rangeMin] = 0x00a7;
            mapDataStd[2][0xf6 - rangeMin] = 0x03c8;
            mapDataStd[2][0xf7 - rangeMin] = 0x0385;
            mapDataStd[2][0xf8 - rangeMin] = 0x00b0;
            mapDataStd[2][0xf9 - rangeMin] = 0x00a8;
            mapDataStd[2][0xfa - rangeMin] = 0x03c9;
            mapDataStd[2][0xfb - rangeMin] = 0x03cb;
            mapDataStd[2][0xfc - rangeMin] = 0x03b0;
            mapDataStd[2][0xfd - rangeMin] = 0x03ce;
            ...
            mapDataPCL[2][0xef - rangeMin] = 0x00b4;
            mapDataPCL[2][0xf7 - rangeMin] = 0x00b8;
