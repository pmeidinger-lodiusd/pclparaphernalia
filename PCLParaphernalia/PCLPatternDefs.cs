namespace PCLParaphernalia
{
    ...
    public static class PCLPatternDefs
    {
        ...
        static readonly byte[] _shade_1 = { 0x00, 0x00, 0x00, 0x00,
                                   0x40, 0x40, 0x00, 0x00,
                                   0x00, 0x00, 0x00, 0x00,
                                   0x00, 0x00, 0x00, 0x00,
                                   0x00, 0x00, 0x00, 0x00,
        ...
        static readonly byte[] _shade_2 = { 0x00, 0x00, 0x00, 0x00,
                                   0x40, 0x40, 0x00, 0x00,
                                   0x00, 0x00, 0x00, 0x00,
                                   0x04, 0x04, 0x00, 0x00,
                                   0x00, 0x00, 0x00, 0x00,
        ...
        static readonly byte[] _shade_3 = { 0x00, 0x00, 0x60, 0x60,
                                   0x60, 0x60, 0x00, 0x00,
                                   0x00, 0x00, 0x06, 0x06,
                                   0x06, 0x06, 0x00, 0x00,
                                   0x00, 0x00, 0x60, 0x60,
        ...
        static readonly byte[] _shade_4 = { 0xC1, 0xC1, 0xC1, 0xC1,
                                   0x80, 0x80, 0x08, 0x08,
                                   0x1C, 0x1C, 0x1C, 0x1C,
                                   0x08, 0x08, 0x80, 0x80,
                                   0xC1, 0xC1, 0xC1, 0xC1,
        ...
        static readonly byte[] _shade_5 = { 0xC1, 0xC1, 0xEB, 0xEB,
                                   0xC1, 0xC1, 0x88, 0x88,
                                   0x1C, 0x1C, 0xBE, 0xBE,
                                   0x1C, 0x1C, 0x88, 0x88,
                                   0xC1, 0xC1, 0xEB, 0xEB,
        ...
        static readonly byte[] _shade_6 = { 0xE3, 0xE3, 0xE3, 0xE3,
                                   0xE3, 0xE3, 0xFF, 0xFF,
                                   0x3E, 0x3E, 0x3E, 0x3E,
                                   0x3E, 0x3E, 0xFF, 0xFF,
                                   0xE3, 0xE3, 0xE3, 0xE3,
        ...
        static readonly byte[] _shade_7 = { 0xF7, 0xF7, 0xE3, 0xE3,
                                   0xF7, 0xF7, 0xFF, 0xFF,
                                   0x7F, 0x7F, 0x3E, 0x3E,
                                   0x7F, 0x7F, 0xFF, 0xFF,
                                   0xF7, 0xF7, 0xE3, 0xE3,
        ...
        static readonly byte[] _shade_8 = { 0xFF, 0xFF, 0xFF, 0xFF,
                                   0xFF, 0xFF, 0xFF, 0xFF,
                                   0xFF, 0xFF, 0xFF, 0xFF,
                                   0xFF, 0xFF, 0xFF, 0xFF,
                                   0xFF, 0xFF, 0xFF, 0xFF,
        ...
        static readonly byte[] _hatch_1 = { 0x00, 0x00, 0x00, 0x00,
                                   0x00, 0x00, 0x00, 0x00,
                                   0x00, 0x00, 0x00, 0x00,
                                   0x00, 0x00, 0xFF, 0xFF,
                                   0xFF, 0xFF, 0x00, 0x00,
        ...
        static readonly byte[] _hatch_2 = { 0x01, 0x80, 0x01, 0x80,
                                   0x01, 0x80, 0x01, 0x80,
                                   0x01, 0x80, 0x01, 0x80,
                                   0x01, 0x80, 0x01, 0x80,
                                   0x01, 0x80, 0x01, 0x80,
        ...
        static readonly byte[] _hatch_3 = { 0x80, 0x03, 0x00, 0x07,
                                   0x00, 0x0E, 0x00, 0x1C,
                                   0x00, 0x38, 0x00, 0x70,
                                   0x00, 0xE0, 0x01, 0xC0,
                                   0x03, 0x80, 0x07, 0x00,
        ...
        static readonly byte[] _hatch_4 = { 0xC0, 0x01, 0xE0, 0x00,
                                   0x70, 0x00, 0x38, 0x00,
                                   0x1C, 0x00, 0x0E, 0x00,
                                   0x07, 0x00, 0x03, 0x80,
                                   0x01, 0xC0, 0x00, 0xE0,
        ...
        static readonly byte[] _hatch_5 = { 0x01, 0x80, 0x01, 0x80,
                                   0x01, 0x80, 0x01, 0x80,
                                   0x01, 0x80, 0x01, 0x80,
                                   0x01, 0x80, 0xFF, 0xFF,
                                   0xFF, 0xFF, 0x01, 0x80,
        ...
        static readonly byte[] _hatch_6 = { 0xC0, 0x03, 0xE0, 0x07,
                                   0x70, 0x0E, 0x38, 0x1C,
                                   0x1C, 0x38, 0x0E, 0x70,
                                   0x07, 0xE0, 0x03, 0xC0,
                                   0x03, 0xC0, 0x07, 0xE0,
