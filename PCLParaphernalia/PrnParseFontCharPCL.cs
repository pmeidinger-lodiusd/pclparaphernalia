...
namespace PCLParaphernalia
{
    ...
    internal class PrnParseFontCharPCL
    {
                                       ...
                                       DataTable table)
        {
            ...
            _options.GetOptPCLDraw(ref _drawCharShape, ref _drawCharMaxHeight, ref _drawCharMaxWidth);
            ...
            if (_nextStage == Stage.CheckDesc)
            {
                ...
                if ((_charDescLen + _blockHddrLen) > _charLen)
                {
                    ...
                    PrnParseCommon.AddTextRow(
                        ...
                        "*** Warning ***",
                        string.Empty,
                        $"Descriptor size ({_charDescLen} bytes) inconsistent with");
        ...
        private void ProcessBlockHeader(ref int bufRem, ref int bufOffset)
        {
            string itemDesc;
        ...
        private void ProcessChecksum(ref int bufRem, ref int bufOffset)
        {
            PrnParseConstants.ContType contType;
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        PrnParseCommon.AddDataRow(
                            ...
                            "Reserved byte",
                            "[ 1 byte ]",
                            "0x" + PrnParseCommon.ByteToHexString(crntByte));
                        ...
                        if (_charChksVal != crntByte)
                        {
                            ...
                            PrnParseCommon.AddTextRow(
                                ...
                                "*** Warning ***",
                                string.Empty,
                                "Calculated checksum is 0x" + PrnParseCommon.ByteToHexString(crntByte));
        ...
        private void ProcessDescriptor(ref int bufRem, ref int bufOffset)
        {
            uint ui32a;
            ushort ui16a;
            ...
            else if (_charFormat == PCLCharFormat.Intellifont)
            {
                ...
                if (charDescExtra > 0)
                {
                    ...
                    PrnParseCommon.AddTextRow(
                        ...
                        "***Warning***",
                        string.Empty,
                        $"Descriptor size ({_charDescLen} bytes) larger than expected (2 bytes)");
        ...
        private void ProcessIntellifontDataBody(ref int bufRem, ref int bufOffset)
        {
            PrnParseConstants.ContType contType;
        ...
        private void ProcessIntellifontDataHddr(ref int bufRem, ref int bufOffset)
        {
            PrnParseConstants.ContType contType;
            ...
            else
            {
                ...
                if (_charClass == PCLCharClass.Intellifont)
                {
                    ...
                    PrnParseCommon.AddTextRow(
                        ...
                        "Contour Data Size:",
                        string.Empty,
                        $"{contourDataSize} bytes(header = {hddrLen}; glyph data = {_charDataLen})");
        ...
        private void ProcessTrueTypeDataHddr(ref int bufRem, ref int bufOffset)
        {
            PrnParseConstants.ContType contType;
            ...
            else
            {
                ...
                PrnParseCommon.AddTextRow(
                    ...
                    "Character Data Size:",
                    string.Empty,
                    $"{charDataSize} bytes (header = {hddrLen}; glyph data = {_charDataLen})");
