namespace PCLParaphernalia
{
    ...
    static partial class PCLSymSetMaps
    {
        ...
        private static void unicodeMap_0I()
        {
            const eSymSetMapId mapId = eSymSetMapId.map_0I;
            ...
            mapDataStd[0][0x5d - rangeMin] = 0x00e9;
            mapDataStd[0][0x5e - rangeMin] = 0x005e;

            mapDataStd[0][0x60 - rangeMin] = 0x00f9;

            mapDataStd[0][0x7b - rangeMin] = 0x00e0;
            mapDataStd[0][0x7c - rangeMin] = 0x00f2;
            mapDataStd[0][0x7d - rangeMin] = 0x00e8;
            mapDataStd[0][0x7e - rangeMin] = 0x00ec;
