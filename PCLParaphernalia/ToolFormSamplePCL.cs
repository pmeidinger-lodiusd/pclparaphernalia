    ...
    static class ToolFormSamplePCL
    {
                                         ...
                                         int macroIdRear)
        {
            ...
            if (firstPage)
            {
                ...
                if (indxMethod == MacroMethod.Overlay)
                {
                    PCLWriter.WriteMacroControl(prnWriter,
                                            (short)macroIdMain,
                                            PCLWriter.MacroControl.Overlay);
                }
            }
            else
            {
            ...
            if (pageUsesForm)
            {
                if (indxMethod == MacroMethod.CallBegin)
                {
                    PCLWriter.WriteMacroControl(prnWriter,
                                            (short)macroId,
                                            PCLWriter.MacroControl.Call);
                }
                else if (indxMethod == MacroMethod.ExecuteBegin)
                {
                    PCLWriter.WriteMacroControl(prnWriter,
                                            (short)macroId,
                                            PCLWriter.MacroControl.Execute);
                }
            }
            ...
            if (flagPrintDescText)
            {
                ...
                if (firstPage)
                {
                    ...
                    PCLWriter.Text(prnWriter, posX, posY, 0, macroMethodNames[(int)indxMethod]);
                    ...
                    PCLWriter.Text(prnWriter, posX, posY, 0, textOrientRear);
                    ...
                    if (flagMainForm)
                    {
                        ...
                        {
                            PCLWriter.Text(prnWriter, posX, posY, 0, formFileMain.Substring(0, halfLen) + " ... " + formFileMain.Substring(len - halfLen, halfLen));
                        }
                    }
                    ...
                    if (flagRearForm)
                    {
                        ...
                        {
                            PCLWriter.Text(prnWriter, posX, posY, 0, formFileRear.Substring(0, halfLen) + " ... " + formFileRear.Substring(len - halfLen, halfLen));
                        }
                    }
                }
            }
            ...
            if (pageUsesForm)
            {
                if (indxMethod == MacroMethod.CallEnd)
                {
                    PCLWriter.WriteMacroControl(prnWriter,
                                            (short)macroId,
                                            PCLWriter.MacroControl.Call);
                }
                else if (indxMethod == MacroMethod.ExecuteEnd)
                {
                    PCLWriter.WriteMacroControl(prnWriter,
                                            (short)macroId,
                                            PCLWriter.MacroControl.Execute);
            ...
            if (flagRearForm && flagRearBPlate)
            {
                ...
                if ((indxMethod == MacroMethod.CallBegin) ||
                    (indxMethod == MacroMethod.CallEnd))
                {
                    PCLWriter.WriteMacroControl(prnWriter,
                                            (short)macroIdRear,
                                            PCLWriter.MacroControl.Call);
                         ...
                         (indxMethod == MacroMethod.ExecuteEnd))
                {
                    PCLWriter.WriteMacroControl(prnWriter,
                                            (short)macroIdRear,
                                            PCLWriter.MacroControl.Execute);
