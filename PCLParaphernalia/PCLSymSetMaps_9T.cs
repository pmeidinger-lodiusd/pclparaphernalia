namespace PCLParaphernalia
{
    ...
    static partial class PCLSymSetMaps
    {
        ...
        private static void UnicodeMap_9T()
        {
            const eSymSetMapId mapId = eSymSetMapId.map_9T;
            ...
            mapDataPCL[2][0x8d - rangeMin] = 0x0131;
            ...
            mapDataPCL[2][0x98 - rangeMin] = 0x0130;
            mapDataPCL[2][0x99 - rangeMin] = 0x00d6;
            mapDataPCL[2][0x9a - rangeMin] = 0x00dc;
            mapDataPCL[2][0x9b - rangeMin] = 0x00a2;
            mapDataPCL[2][0x9c - rangeMin] = 0x00a3;
            mapDataPCL[2][0x9d - rangeMin] = 0x00a5;
            mapDataPCL[2][0x9e - rangeMin] = 0x015e;
            mapDataPCL[2][0x9f - rangeMin] = 0x015f;
            ...
            mapDataPCL[2][0xa6 - rangeMin] = 0x011e;
            mapDataPCL[2][0xa7 - rangeMin] = 0x011f;
            mapDataPCL[2][0xa8 - rangeMin] = 0x00bf;
            mapDataPCL[2][0xa9 - rangeMin] = 0x2310;
            mapDataPCL[2][0xaa - rangeMin] = 0x00ac;
            mapDataPCL[2][0xab - rangeMin] = 0x00bd;
            mapDataPCL[2][0xac - rangeMin] = 0x00bc;
            mapDataPCL[2][0xad - rangeMin] = 0x00a1;
            mapDataPCL[2][0xae - rangeMin] = 0x00ab;
            mapDataPCL[2][0xaf - rangeMin] = 0x00bb;
            ...
            mapDataPCL[2][0xe1 - rangeMin] = 0x03b2;
