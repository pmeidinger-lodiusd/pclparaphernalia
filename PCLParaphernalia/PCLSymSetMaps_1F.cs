...
namespace PCLParaphernalia
{
    ...
    static partial class PCLSymSetMaps
    {
        ...
        private static void unicodeMap_1F()
        {
            const eSymSetMapId mapId = eSymSetMapId.map_1F;
            ...
            mapDataStd[0][0x40 - rangeMin] = 0x00e0;

            mapDataStd[0][0x5b - rangeMin] = 0x00b0;
            mapDataStd[0][0x5c - rangeMin] = 0x00e7;
            mapDataStd[0][0x5d - rangeMin] = 0x00a7;
            mapDataStd[0][0x5e - rangeMin] = 0x005e;

            mapDataStd[0][0x60 - rangeMin] = 0x00b5;

            mapDataStd[0][0x7b - rangeMin] = 0x00e9;
            mapDataStd[0][0x7c - rangeMin] = 0x00f9;
            mapDataStd[0][0x7d - rangeMin] = 0x00e8;
            mapDataStd[0][0x7e - rangeMin] = 0x00a8;
