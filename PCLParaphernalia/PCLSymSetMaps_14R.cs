namespace PCLParaphernalia
{
    ...
    static partial class PCLSymSetMaps
    {
        ...
        // ID       14R                                                       //
        // Kind1    466                                                       //
        // Name     PC866 Ukrainian                                           //
        //                                                                    //
        //--------------------------------------------------------------------//

        private static void UnicodeMap_14R()
        {
            const eSymSetMapId mapId = eSymSetMapId.map_14R;
            ...
            mapDataStd[2][0xf2 - rangeMin] = 0x0490;
            mapDataStd[2][0xf3 - rangeMin] = 0x0491;
            mapDataStd[2][0xf4 - rangeMin] = 0x0404;
            mapDataStd[2][0xf5 - rangeMin] = 0x0454;
            mapDataStd[2][0xf6 - rangeMin] = 0x0406;
            mapDataStd[2][0xf7 - rangeMin] = 0x0456;
            mapDataStd[2][0xf8 - rangeMin] = 0x0407;
            mapDataStd[2][0xf9 - rangeMin] = 0x0457;
